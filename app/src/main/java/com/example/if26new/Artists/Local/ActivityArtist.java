package com.example.if26new.Artists.Local;
...
import com.example.if26new.Artists.Local.Album.FragmentAlbum;
import com.example.if26new.Artists.Local.Track.TitlesFragment;
import com.example.if26new.Artists.PageAdapterForArtist;
import com.example.if26new.Artists.Local.Bio.fragment_bio;
...
public class ActivityArtist extends AppCompatActivity{
    ...
    private void setViewPager(ViewPager viewPager) {
        ...
        FragmentAlbum frg=new FragmentAlbum();
